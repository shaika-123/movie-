...
export default function RegistrationForm() {
  ...
  return (
    <>
      {/* Back to Home Link - Only show when NOT viewing ticket */}
      {!submitted && (
        <Link
          href="/"
      ...
      <section className="min-h-screen py-20 px-4 sm:px-6 lg:px-8 flex items-center justify-center">
        <div className="max-w-2xl w-full">
          {/* Show Ticket if registration successful */}
        {submitted && ticketData ? (
          <div className="space-y-8 animate-in fade-in duration-500">
            {/* Success Header */}
            <div className="text-center">
              <h2 className="text-4xl sm:text-5xl font-bold text-white mb-4">
                ✅ Welcome to <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">ASTRA</span>
              </h2>
